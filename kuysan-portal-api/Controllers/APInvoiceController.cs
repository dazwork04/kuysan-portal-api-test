...
namespace SAPB1SLayerWebAPI.Controllers
{
    ...
    public class APInvoiceController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateAPInvoice(int userId, string companyDB, Document apInvoice) => Ok(await apiService.CreateAPInvoiceAsync(userId, companyDB, apInvoice));
