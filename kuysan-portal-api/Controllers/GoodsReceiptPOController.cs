...
namespace SAPB1SLayerWebAPI.Controllers
{
    ...
    public class GoodsReceiptPOController : ControllerBase
    {
        ...
        [HttpPost("CreateGoodsReceiptPO/{userId}/{companyDB}")]
        public async Task<IActionResult> CreateGoodsReceiptPO(int userId, string companyDB, Document goodsReceiptPO) => Ok(await grpoService.CreateGoodsReceiptPOAsync(userId, companyDB, goodsReceiptPO));
