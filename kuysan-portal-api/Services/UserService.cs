...
namespace SAPB1SLayerWebAPI.Services
{
    public class UserService
    {
        ...
        // CREATE USER
        public async Task<Response> CreateUserAsync(int userId, string companyDB, User user) => await Task.Run(() =>
        {
            try
            {
                var connection = Main.GetConnection(userId, companyDB);
        ...
        // UPDATE USER
        public async Task<Response> UpdateUserAsync(int userId, string companyDB, User user) => await Task.Run(() =>
        {
            try
            {
                var connection = Main.GetConnection(userId, companyDB);
