    ...
    public class PickListService
    {
        ...
        public async Task<Response> GetPickListDeliveryAsync(int userId, string companyDB, int absEntry, string orderEntries) => await Task.Run(async () =>
        {
            try
            {
                ...
                Logger.CreateLog(false, "GET PICK LIST DELIVERY ASYNC", "SUCCESS", JsonConvert.SerializeObject(new
                {
                    AbsEntry = absEntry,
            ...
            {
                Logger.CreateLog(true, "GET PICK LIST DELIVERY ASYNC", ex.Message, JsonConvert.SerializeObject(new
                {
                    AbsEntry = absEntry,
                    OrderEntries = orderEntries
                }));
